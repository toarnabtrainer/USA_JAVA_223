...
class GenericFunctionalInterfaceDemo6 {
	public static void main(String args[]) {
		...
		System.out.println("The factoral of 3 is " + factorial.func(3));  // 6
		System.out.println("The factoral of 5 is " + factorial.func(5));  // 120
	}
}